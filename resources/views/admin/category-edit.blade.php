                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="name" id="first-name" required="required" class="form-control col-md-7 col-xs-12" value="@if(isset($category->name)){{$category->name}}@endif">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea class="form-control col-md-7 col-xs-12" name="description">@if(isset($category->description)){{$category->description}}@endif</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea class="form-control col-md-7 col-xs-12" name="keyword">@if(isset($category->keyword)){{$category->keyword}}@endif</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <div style="margin-top: 10px">
                                <label>
                                    <input type="checkbox" name="type" @if(isset($category->type)) checked @endif  />
                                </label>
                            </div>
                        </div>
                    </div>
